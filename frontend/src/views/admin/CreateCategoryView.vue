<template>
  <div class="create-category-container">
    <div class="page-header">
      <h1>{{ $t('admin.category.page.create.title') }}</h1>
      <p>{{ $t('admin.category.page.create.description') }}</p>
    </div>
    ...
    >
      ...
      <el-form-item :label="$t('admin.category.page.form.slug')" prop="slug">
        ...
        />
        <div class="form-hint">
          {{ $t('admin.category.page.form.slug_helptip') }}
        </div>
      </el-form-item>
      ...
      <el-form-item class="form-actions">
        ...
        <el-button type="primary" @click="handleSubmit">{{
          $t('admin.category.page.create.btn')
        }}</el-button>
      </el-form-item>
    </el-form>
  </div>
...
import { createCategory, getManageCategoryList } from '@/api/services/categories'
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (valid) {
      ...
      console.log(res)
      if (res.code === 1) {
        ElMessage.success(t('admin.category.page.create.success'))
        router.push('/admin/categories')
      } else {
        ElMessage.error(t('admin.category.page.create.error'))
      }
    }
